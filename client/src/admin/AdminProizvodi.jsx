...
function AdminProizvodi() {
  ...
  const toggleNovo = (id) => {
    apiFetch(`/api/products/${id}/toggle-novo`, {
      method: "PATCH",
    })
      .then((res) => res.json())
      .then((updated) => {
  ...
  const potvrdiBrisanjeProizvoda = () => {
    apiFetch(`/api/products/${proizvodZaBrisanje._id}`, {
      method: "DELETE",
    })
      .then((res) => {
  ...
  useEffect(() => {
    ...
    apiFetch(
      `/api/products/kategorija/${aktivnaKategorija._id}`
    )
      .then((res) => res.json())
      .then((data) => {
            ...
            {kategorije.map((kat) => (
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage: `url(${apiUrl(kat.slika)})`,
                  }}
                ></div>
          ...
          <div className="admin-modal">
            ...
            <form
              onSubmit={(e) => {
                ...
                apiFetch(`/api/products/${editProizvod._id}`, {
                  method: "PUT",
                  body: formData,
                })
                  .then((res) => res.json())
